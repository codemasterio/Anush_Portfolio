...
// Utility function to replace the cn import
const cn = (...classes: (string | undefined | boolean)[]) => clsx(classes);
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-7 w-7 rounded-full bg-zinc-800 flex items-center justify-center group/button"
            >
